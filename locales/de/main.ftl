...
feed-welcome = Hallo, {$name}!
feed-who-are-you = Wer bist du?
feed-name-placeholder = Dein Name...
feed-valid-name = ✨ VOLL COOLER NAME!
feed-invalid-name = 🛑 STOPP! SO NICHT.
feed-post-button = POSTEN! 🚀
